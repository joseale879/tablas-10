...
('Física Básica','Curso inicial de física'),
('Física Avanzada','Técnicas avanzadas de física'),
('Química Básica','Curso inicial de química'),
('Química Avanzada','Técnicas avanzadas de química'),
('Biología Inicial','Curso inicial de biología'),
('Biología Avanzada','Curso avanzado de biología'),
('Astronomía','Introducción a la astronomía'),
('Geología','Curso de geología básica'),
('Ecología','Estudio del ecosistema'),
...
('Carlos Ruiz','Física'),
('Laura Medina','Química'),
('Jorge Silva','Biología'),
('Ana Beltrán','Astronomía'),
('Esteban Cruz','Geología'),
('Paula Ortiz','Ecología'),
('Nicolás Bravo','Robótica'),
('Sandra Ramos','Matemáticas'),
('Diego Peña','Tecnología'),
('María Gómez','Ciencias Sociales');
