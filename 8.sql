...
CREATE OR ALTER PROCEDURE sp_CrearBaseDeDatosYTablas_Tecnologia
AS
BEGIN
    SET NOCOUNT ON;

    IF DB_ID('PlataformaTecnologia') IS NOT NULL
        DROP DATABASE PlataformaTecnologia;

    CREATE DATABASE PlataformaTecnologia;

    EXEC('
        USE PlataformaTecnologia;
...
EXEC sp_CrearBaseDeDatosYTablas_Tecnologia;
GO
...
('Python Básico','Introducción a Python'),
('Python Avanzado','Python avanzado y proyectos'),
('Java Básico','Introducción a Java'),
('Java Avanzado','Java avanzado y proyectos'),
('C# Básico','Introducción a C#'),
('C# Avanzado','C# avanzado y proyectos'),
('HTML y CSS','Desarrollo web básico'),
('JavaScript','Programación web con JS'),
('SQL Básico','Bases de datos inicial'),
('SQL Avanzado','Bases de datos avanzado');
...
('Jorge Silva','C#'),
('Ana Beltrán','Web'),
('Esteban Cruz','JavaScript'),
('Paula Ortiz','SQL'),
('Nicolás Bravo','Bases de Datos'),
('Sandra Ramos','Front-End'),
('Diego Peña','Back-End'),
('María Gómez','Programación');
