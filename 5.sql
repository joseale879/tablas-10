...
CREATE OR ALTER PROCEDURE sp_CrearBaseDeDatosYTablas_Deportes
AS
BEGIN
    SET NOCOUNT ON;

    IF DB_ID('PlataformaDeportes') IS NOT NULL
        DROP DATABASE PlataformaDeportes;

    CREATE DATABASE PlataformaDeportes;

    EXEC('
        USE PlataformaDeportes;
...
EXEC sp_CrearBaseDeDatosYTablas_Deportes;
GO
...
('Fútbol Básico','Entrenamiento inicial de fútbol'),
('Fútbol Avanzado','Técnicas avanzadas de fútbol'),
('Baloncesto Básico','Entrenamiento básico de baloncesto'),
('Baloncesto Avanzado','Técnicas avanzadas de baloncesto'),
('Natación Inicial','Curso inicial de natación'),
('Natación Avanzada','Técnicas avanzadas de natación'),
('Tenis Básico','Entrenamiento inicial de tenis'),
('Tenis Intermedio','Técnicas intermedias de tenis'),
('Voleibol Básico','Curso básico de voleibol'),
('Voleibol Avanzado','Curso avanzado de voleibol');
...
('Carlos Ruiz','Fútbol'),
('Laura Medina','Baloncesto'),
('Jorge Silva','Natación'),
('Ana Beltrán','Tenis'),
('Esteban Cruz','Voleibol'),
('Paula Ortiz','Atletismo'),
('Nicolás Bravo','Ciclismo'),
('Sandra Ramos','Gimnasia'),
('Diego Peña','Boxeo'),
('María Gómez','Yoga');
