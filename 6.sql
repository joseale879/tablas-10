...
CREATE OR ALTER PROCEDURE sp_CrearBaseDeDatosYTablas_Arte
AS
BEGIN
    SET NOCOUNT ON;
...
EXEC sp_CrearBaseDeDatosYTablas_Arte;
GO
...
('Dibujo Básico','Aprender dibujo desde cero'),
('Dibujo Avanzado','Técnicas avanzadas de dibujo'),
('Pintura Acrílica','Curso de pintura acrílica'),
('Pintura Óleo','Curso de pintura al óleo'),
('Escultura Inicial','Introducción a la escultura'),
('Escultura Avanzada','Técnicas de escultura avanzada'),
('Fotografía Básica','Curso de fotografía inicial'),
('Fotografía Avanzada','Curso avanzado de fotografía'),
('Arte Digital','Diseño y arte digital'),
('Ilustración','Curso de ilustración creativa');
...
('Carlos Ruiz','Dibujo'),
('Laura Medina','Pintura'),
('Jorge Silva','Escultura'),
('Ana Beltrán','Fotografía'),
('Esteban Cruz','Arte Digital'),
('Paula Ortiz','Ilustración'),
('Nicolás Bravo','Grabado'),
('Sandra Ramos','Cerámica'),
('Diego Peña','Diseño'),
('María Gómez','Artesanía');
